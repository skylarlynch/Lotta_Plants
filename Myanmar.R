...
ggplot() +
  ...
  labs(title= "Isthmus of Kra - Myanmar",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/Myanmar_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
