...
ggplot() +
  ...
  xlim(0,365) +
  labs(title= "Tropenbos International Chiquitania Bolivia",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/Bolivia_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
