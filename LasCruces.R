...
ggplot() +
  ...
  labs(title= "Las Cruces Research Station Costa Rica",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/LasCruces_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
