...
df <- read.csv("CochaCashu(new).csv")
...
ggplot() +
  ...
  labs(title= "Cocha Cashu in Manu Parque Nacional Peru",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/CochaCashu(new)_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
