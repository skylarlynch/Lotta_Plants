...
ggplot() +
  ...
  labs(title= "Tabora Miombo Woodland Research Station",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/Miombo_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
