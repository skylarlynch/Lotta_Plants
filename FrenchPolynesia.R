...
df <- read.csv("FrenchPolynesia.csv")
...
ggplot() +
  ...
  labs(title= "Grunp Station French Polynesia",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/FrenchPolynesia_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
