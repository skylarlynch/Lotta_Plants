...
ggplot() +
  ...
  labs(title= "Jatun Sacha Biological Station Ecuador",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/JatunSacha_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
