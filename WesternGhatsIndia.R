...
df <- read.csv("WesternGhatsIndia.csv")
...
ggplot() +
  ...
  labs(title= "Sirsi Field Station India",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/WesternGhatsIndia_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
