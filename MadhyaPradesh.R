...
ggplot() +
  ...
  labs(title= "Tropical Forest Research Institute India",
...
for(i in 1:length(spec)){
  ...
  ggsave(filename = paste("C:/Users/skly5321/Downloads/ChapterOne/ChapterOne/Plots/MadhyaPradesh_All_Plots/",spec[i],"_plot.png",sep=""),device = "png")
}
